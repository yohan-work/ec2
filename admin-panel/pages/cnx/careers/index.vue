    ...
    >
      <template #business>
        ...
        <section class="inner">
          ...
          <CareersBanner 
            title="상시채용" 
            content="콘센트릭스 코리아는 전문가 분들을 기다리고 있습니다.<br>지원서를 보내주시면 인사팀 담당자가 업무 역할에 맞는 팀과 연결하여 빠르게 연락 드립니다." 
            buttonText="지원하기" 
            href="mailto:recruiter_catalyst_korea@concentrix.com" 
          />
