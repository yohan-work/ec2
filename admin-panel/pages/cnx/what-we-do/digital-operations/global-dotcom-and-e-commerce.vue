    ...
    <div class="inner">
      ...
      <section class="title-section">
        <AppTitle 
          ...
          text="닷컴에서 이커머스까지 글로벌 비즈니스를 위해 필요한 플랫폼에 있어 <br>각 기업에 최적화된 솔루션을 제공하고, 고객사의 고민과 이슈들을 함께 해결합니다. <br>지난 약 20년간 글로벌 Top tier 전자, 자동차, 코스메틱 인더스트리 경험을 통해 <br>누적된 풍부한 경험과 노하우를 기반으로 혁신적인 서비스를 속도감있게 수행합니다."/>
      </section>
