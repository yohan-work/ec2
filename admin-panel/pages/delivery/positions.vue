    ...
    <TitleArea title="직급 관리">
      ...
      <template #right>
        <div class="right-content">
          ...
          <Button variant="primary" size="md"> 새 직급 추가 </Button>
        </div>
      </template>
    </TitleArea>
    <ContentsArea>
...
// 테이블 데이터
const tableHeaders = [
  { key: 'positionName', label: '직급명' },
  { key: 'level', label: '레벨' },
  { key: 'description', label: '설명' },
  { key: 'employeeCount', label: '직원 수' },
  { key: 'minSalary', label: '최소 급여' },
